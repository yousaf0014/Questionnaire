...
@section('content')
    <div class="panel panel-primary">
        <div class="panel-heading">
            ...
            <a class="pull-right btn btn-default btn-sm" href="{{url('/Questions',$question->questionnaire->id)}}">
                <span class="glyphicon glyphicon-circle-arrow-left"></span>&nbsp;Go Back
            </a>  
            <a href="javascript:;" onclick="submitForm()"class="btn btn-default pull-right btn-sm">Save</a>    
